...
class ICThemeData {
  ...
  XmlElement toXml({bool verbose = false}) {
    ...
    final appBarThemeElement = appBarTheme != null ? XmlElement(XmlName("appBarTheme"), [], [appBarTheme!.toXml(verbose: verbose)]) : XmlElement(XmlName("appBarTheme"),[],[XmlText("")]);
    final textThemeElement = textTheme != null ? XmlElement(XmlName("textTheme"), [], [textTheme!.toXml(verbose: verbose)]) : XmlElement(XmlName("textTheme"),[],[XmlText("")]);
