...
class ICAppBarTheme {
  ...
  XmlElement toXml({bool verbose = false}) {
    ...
    final toolStyleElement = toolbarStyle != null ? toolbarStyle!.toXml(verbose: verbose) : XmlElement(XmlName("toolbarTextStyle"),[],[XmlText("")]);
    final titleStyleElement = titleStyle != null ? titleStyle!.toXml(verbose: verbose) : XmlElement(XmlName("titleTextStyle"),[],[XmlText("")]);
